...
import HumanRessourcesNav from "../../admin/Indexes/HumanRessources";
import { CustomSelect2 } from "../../../Components/form/CustomSelect2";

export default function AddOneStudent({ teacher, selectedRole }) {
 ...
 console.log(selectedRole , '+', initialValues.role);
  ...
  const handleConfirm = () => {
    ...
    router.post('/humanResources', payload, {
      onSuccess: () => {
          ...
          <FormContainer title="Professional Information" icon={BriefcaseBusiness}>
            ...
            {values.role === '3' && (
              <CustomSelect2
                ...
                value={values.type}
                handleChange={handleChange}
                options= {teacher.map((t) => ( {value: t.id, label: t.teacher_type} ))
                }// options={[
