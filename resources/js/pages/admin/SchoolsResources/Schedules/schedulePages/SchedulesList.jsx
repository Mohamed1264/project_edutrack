...
                    const successMessage = page?.props?.flash?.success || (page && page.message) || 'Horaire effacé avec succès';
...
                <h1 className='text-xl flex-1 text-gray-700 dark:text-gray-50 font-bold'>Horaires {type}</h1>
            </div>
...
            </div>
            <div>
                <h1 className='text-xl font-semibold'>Liste des Horaires </h1>
...
                                    <h1 className='text-lg text-gray-700 dark:text-gray-50 font-bold mb-3'>Horaires Sélectionnés</h1> 
                                    {/* <button
